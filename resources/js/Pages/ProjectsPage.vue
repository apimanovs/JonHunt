    ...
    <div class="my-10 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <div class="lg:col-span-2 bg-white dark:bg-gray-800 shadow sm:rounded-lg p-6 sm:p-2">
        ...
        <div class="creator-info flex flex-wrap items-center mt-4 mb-6">
          ...
          <a :href="`/user/${project.creator.username}`" class="text-gray-800 dark:text-gray-200 font-medium hover:text-blue-500 transition break-words">
            {{ project.creator.name }}
            <span v-if="project.creator.role === 'freelancer'" class="ml-2 px-2 py-0.5 bg-blue-100 text-blue-800 text-xs rounded-full">
              Freelancer
            </span>
          </a>
        </div>
        ...
        <div v-if="currentUserApplication" class="mt-8 lg:mt-10 bg-gray-50 dark:bg-gray-700 p-6 rounded border dark:border-gray-600">
      ...
      <div class="sticky top-28 self-start space-y-4">
        <div v-if="canApply" class="bg-blue-50 dark:bg-gray-900 p-6 rounded shadow">
          ...
          <form @submit.prevent="submitApplication" class="space-y-4">
            ...
            <button class="px-4 py-2 bg-red-600 text-white rounded hover:bg-red-700 w-full">
              Submit Application
            </button>
          </form>
        </div>
