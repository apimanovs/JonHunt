        ...
        <table class="min-w-full text-left divide-y divide-gray-200 table-auto">
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            <tr v-for="jobAd in jobAds.data" :key="jobAd.id">
              ...
              <td class="px-6 py-4 truncate max-w-[150px]">{{ jobAd.Title }}</td>
              <td class="px-6 py-4 truncate max-w-[250px]">{{ jobAd.Description }}</td>
...
const props = defineProps({
  jobAds: Object, // paginated job ads data
})
